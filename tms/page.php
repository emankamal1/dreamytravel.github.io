...
<meta name="keywords" content="Dreamy Travels" />
...
<div class="banner-1 ">
	<div class="container">
		...
		style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Dreamy Travels</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
?>
		...
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
		 style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;"><?php 	
		echo $_GET['type'] ?></h3>
