...
<html>
<head>
<title>Dreamy Travels | Vendor manage packages</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/Tourism-Management-System-using-PHP-MySQL-TMS/tms/index.php">Home</a><i class="fa fa-angle-right"></i>Manage Packages</li>
            </ol>
